...
const GiftSuggestionCard: React.FC<GiftSuggestionCardProps> = ({ suggestion }) => {
    ...
    return (
        <div className="h-full w-full max-w-2xl mx-auto bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 shadow-2xl shadow-violet-500/10 rounded-3xl p-6 sm:p-8 flex flex-col items-center transition-transform transition-shadow duration-300 ease-in-out lg:hover:scale-105 lg:hover:shadow-3xl lg:hover:shadow-[#a259ff]/40">
